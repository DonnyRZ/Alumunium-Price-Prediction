...
def render_history_plot(history: pd.DataFrame) -> None:
    ...
    ax.plot(plot_df["base_date"], plot_df["model_price_t1"], label="Model", linewidth=2)
    ax.plot(plot_df["base_date"], plot_df["baseline_price_t1"], label="Baseline", linewidth=2)
